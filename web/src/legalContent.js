/** Plain-language legal copy kept beside the web interface translations. */
export const legalContent = {
  en: {
    ...
    terms: {
      ...
      updated: "Last updated: 19 August 2026",
      sections: [
        ["Using JaundiCare safely", "Use JaundiCare for newborn-care education, screening support and referral guidance. It does not diagnose jaundice. Seek urgent medical care for a very sleepy or floppy baby, poor feeding, seizures, breathing difficulty, fever, pale stool, or any serious concern."],
        ["Your responsibility", "Provide accurate information and keep your phone and verification code private. Do not use another person's account or delay necessary clinical care because of a screening result."],
        ["Service availability", "Sign-in, live facilities and assistant features need an internet connection. They may be unavailable during network or provider outages."],
      ],
    },
  },
  yo: {
    ...
    terms: {
      ...
      updated: "Ìmúdójúìwò tó kẹ́yìn: ọjọ́ 19, oṣù Kẹjọ 2026",
      sections: [
        ["Lílo JaundiCare ní ààbò", "Lo JaundiCare fún ìmọ̀ nípa ìtọ́jú ọmọ tuntun, ìtìlẹ́yìn ìṣàyẹ̀wò àti ìtọ́sọ́nà ìfiránṣẹ́ sí ibìkan ìtọ́jú. Kò ṣe ìdánimọ̀ jaundice. Wá ìtọ́jú pajawiri bí ọmọ bá sùn jù, ara rẹ̀ rọ̀, kò fẹ́ mú ọmú, ní ìjà, ìṣòro mími, ibà, ìgbẹ́ funfun, tàbí ìbànújẹ kankan tó le."],
        ["Ojúsẹ́ rẹ", "Pèsè ìwífún tó tọ́, kí o sì dáàbò bo fóònù àti kóòdù ìmúdájú rẹ. Má ṣe lo àkọọ́lẹ̀ ẹlòmíràn, tàbí kí o fi àbájáde ìṣàyẹ̀wò dá ìtọ́jú tó yẹ dúró."],
        ["Wíwà iṣẹ́", "Wíwọlé, ìwífún ilé ìwòsàn tó wà nítòsí àti àwọn olùrànlọ́wọ́ nilo ayélujára. Wọ́n lè má ṣiṣẹ́ nígbà tí nẹ́tíwọ́ọ̀kì tàbí olùpèsè iṣẹ́ bá ní ìṣòro."],
      ],
    },
  },
  ha: {
    ...
    terms: {
      ...
      updated: "An sabunta: 19 Agusta 2026",
      sections: [
        ["Amfani da JaundiCare cikin aminci", "Yi amfani da JaundiCare don ilimin kula da jarirai, tallafin bincike da jagorar zuwa wurin kulawa. Ba ya gano jaundice. Nemi kulawar gaggawa idan jariri yana da wahalar tashi, jikinsa ya yi laushi, baya shan nono, yana da farfadiya, wahalar numfashi, zazzabi, bayan gida fari, ko duk wata babbar damuwa."],
        ["Nauyinka", "Ba da bayanin daidai kuma ka kiyaye wayarka da lambar tabbatarwa. Kada ka yi amfani da asusun wani ko ka jinkirta kulawar asibiti da ake bukata saboda sakamakon bincike."],
        ["Samuwar sabis", "Shiga asusu, wuraren kulawa na kai tsaye da mataimaka suna buƙatar intanet. Suna iya kasa aiki yayin matsalar hanyar sadarwa ko mai bayar da sabis."],
      ],
    },
  },
  ig: {
    ...
    terms: {
      ...
      updated: "Emelitere: 19 Ọgọst 2026",
      sections: [
        ["Iji JaundiCare n'enweghị nsogbu", "Jiri JaundiCare maka mmụta nlekọta nwa ọhụrụ, nkwado nyocha na nduzi maka ntụgharị. Ọ naghị achọpụta jaundice. Chọọ nlekọta mberede ma ọ bụrụ na nwa siri ike iteta, ahụ ya dị nro, ọ naghị eri nri, nwere ọdịdọ, nsogbu iku ume, ahụ ọkụ, nsị na-acha ọcha, ma ọ bụ nsogbu ọ bụla siri ike."],
        ["Ọrụ gị", "Nye ozi ziri ezi ma chekwaa ekwentị na koodu nkwado gị. Ejila akaụntụ onye ọzọ ma ọ bụ gbuo oge nlekọta ahụike dị mkpa n'ihi nsonaazụ nyocha."],
        ["Nnweta ọrụ", "Nbanye, ebe nlekọta dị ndụ na ndị enyemaka chọrọ ịntanetị. Ha nwere ike ghara ịdị mgbe netwọkụ ma ọ bụ onye na-enye ọrụ dara."],
      ],
    },
  },
  pcm: {
    ...
    terms: {
      ...
      updated: "Last update: 19 August 2026",
      sections: [
        ["How to use JaundiCare safely", "Use JaundiCare for newborn-care information, screening support and referral guidance. E no dey diagnose jaundice. Go hospital urgently if baby hard to wake, body weak, no dey feed well, get seizure, breathing problem, fever, pale stool, or any serious worry."],
        ["Your responsibility", "Give correct information and protect your phone and verification code. No use another person's account or delay clinic care because of screening result."],
        ["When service fit work", "Sign-in, live facility information and assistant features need internet. E fit no work when network or provider get problem."],
      ],
    },
  },
};
